...
export class PreRegistrationController {
  constructor(
    private readonly preRegistrationUseCase: PreRegistrationUseCase,
  ) {}
  ...
  @ApiOperation({
    ...
    description:
      'Crea un usuario en el sistema y una suscripción pendiente de pago para usuarios tipo Cliente.',
  })
  ...
  async preRegister(
    @Body() dto: PreRegistrationRequestDto,
