...
export interface ISubscriptionPlanRepository {
  create(plan: Partial<SubscriptionPlanEntity>): Promise<SubscriptionPlanEntity>;
  update(id: string, plan: Partial<SubscriptionPlanEntity>): Promise<SubscriptionPlanEntity>;
