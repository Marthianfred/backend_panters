...
export interface IPtcPackageRepository {
  create(data: Omit<PtcPackageEntity, 'id' | 'createdAt' | 'updatedAt'>): Promise<PtcPackageEntity>;
  update(id: string, data: Partial<Omit<PtcPackageEntity, 'id' | 'createdAt' | 'updatedAt'>>): Promise<PtcPackageEntity>;
